...
export function IconCard({ icon: Icon, title, text }: IconCardProps) {
  return (
    <div className="group bg-bg-card border border-smoke rounded-xl p-5 hover:border-heat/30 hover:shadow-md">
      <div className="flex items-start gap-3.5">
        <Icon size={20} className="text-heat mt-0.5 shrink-0" />
        <div>
